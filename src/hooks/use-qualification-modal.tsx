...
export const useQualificationModal = create<useQualificationModalStore>((set) => ({
    title: "",
    description: "",
    ...
    setQualification: (value: Partial<Qualification> | undefined) => set({ qualification: value }),
