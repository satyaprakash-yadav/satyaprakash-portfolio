    ...
    return (
        <>
            ...
            <main className="container max-w-6xl px-4 md:px-8 mx-auto -mt-5 xl:mt-5 relative overflow-x-hidden">
                ...
                <p className="mb-4 text-base">Last updated: July 12, 2025</p>
                ...
                <ul className="list-outside list-disc block ml-10">
                    ...
                    <li className="list-item">
                        <p className="mb-4 text-base">
                            ...
                            <a
                                href="https://www.satyaprakash.com"
                                rel="external nofollow noopener"
                                target="_blank"
                            >
                                https://www.satyaprakash.com
                            </a>
                        </p>
                    </li>
                    <li className="list-item">
                ...
                <h2 className="font-bold text-3xl mb-4 pt-4">
                    For Asia Union (AU) Users
                </h2>
                <p className="mb-4 text-base">
                    If You are a Asia Union consumer, you will benefit from any
                    mandatory provisions of the law of the country in which You are
                    resident.
                </p>
                <h2 className="font-bold text-3xl mb-4 pt-4">
                    Indian States Legal Compliance
                </h2>
                <p className="mb-4 text-base">
                    You represent and warrant that (i) You are not located in a country
                    that is subject to the Indian States government embargo, or that has
                    been designated by the Indian States government as a &quot;terrorist
                ...
                <ul className="list-outside list-disc block ml-10">
                    ...
                    <li className="list-item">
                        <p className="mb-4 text-base">
                            ...
                            <Link
                                href="https://www.satyaprakash.com#contact"
                                className="font-medium hover:underline underline-offset-4"
                                rel="external nofollow noopener"
                                target="_blank"
                            >
